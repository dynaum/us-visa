...
function HomeContent() {
  ...
  return (
    <main className="space-y-16">
      <section className="relative overflow-hidden rounded-3xl border border-[var(--border-subtle)] bg-gradient-to-br from-[var(--surface)] via-[var(--surface)] to-brand-50/40 p-8 shadow-sm sm:p-12">
        <div
          aria-hidden
        ...
        <div className="relative space-y-6">
          ...
          <h1 className="max-w-3xl font-[family-name:var(--font-instrument-serif)] text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            {t('home.heading')}
          </h1>
